 ...
 */
function isotp(sendFrameCallback, receivedPayloadCallback) {
 ...
 * @method txInProgress
 */
isotp.prototype.txInProgress = function() {
 ...
 */
isotp.prototype.startTransmission = function(id, data) {
    if (data.length < 8) {
...
isotp.prototype._sendBlock = function() {
 ...
 */
isotp.prototype.parseFrame = function(frame) {
