...
slcan.prototype.open = function() {
    ...
    this._conn = new SerialPort(this._dev_str,{ 'baudRate': 1000000 });
...
slcan.prototype._parseFrame = function(str) {
    ...
    if (str[0] === 't') {
        ...
        is_ext_id = true;
        is_remote = true;
    } else if (str[0] === 'd' || str[0] === 'e') { //this is a hack to support an experimental multibus protocol
        is_ext_id = false;
        is_remote = (str[0] === 'e')?true:false;
        multibus = true;
        //extract the busId from the extended format
        busId = Number(str.substr(1,1));
        //correct str to 'normal' contents
