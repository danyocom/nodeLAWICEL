 ...
 */
function obd(sendFrameCallback, receivedPayloadCallback) {
    this._isotp = new isotp(sendFrameCallback, this._recvDataCallback);
 ...
 */
obd.prototype.sendRequest = function(controllerId, mode, pid) {
 ...
 */
obd.prototype.parseFrame = function(frame) {
    this._isotp.parseFrame(frame);
}

obd.prototype._recvDataCallback = function(data) {
